...
[react-icons](https://react-icons.github.io/react-icons/) repackaged with a typesafe macro.

## Usage

This package is not available on npm. You can clone this repository and run `npm run build` to obtain a ready-to-use bundle in `dist`.
